...
mod tests{
    ...
    fn create_complex_number(){
        let c_num = ComplexNumber::new(2.0, 3.0);
    ...
    fn formatter_display_complex_number(){
        let c_num = ComplexNumber::new(0.0, 0.0);
        assert_eq!(c_num.to_string(), "0+0i");
        
        let c_num = ComplexNumber::new(1.0, 1.0);
        ...
        let c_num = ComplexNumber::new(0.12, -0.34);
    ...
    fn add_complex_numbers(){
        let a = ComplexNumber::new(2.0, 3.0);
        let b = ComplexNumber::new(4.0, 6.0);
        let sum = ComplexNumber::new(6.0, 9.0);
    ...
    fn subtract_complex_numbers(){
        let a = ComplexNumber::new(2.0, 3.0);
        let b = ComplexNumber::new(4.0, 6.0);
        let difference = ComplexNumber::new(-2.0, -3.0);
    ...
    fn multiply_complex_numbers(){
        let a = ComplexNumber::new(2.0, 3.0);
        let b = ComplexNumber::new(4.0, 6.0);
        let product = ComplexNumber::new(-10.0, 24.0);
    ...
    fn division_complex_numbers(){
        let a = ComplexNumber::new(-2.0, 1.0);
        let b = ComplexNumber::new(1.0, 2.0);
        let quotient = ComplexNumber::new(0.0, 1.0);
    ...
    fn conjugate_complex_numbers(){
        let a = ComplexNumber::new(-2.0, 1.0);
        let conj = ComplexNumber::new(-2.0, -1.0);
    ...
    fn test_get_cartesian(){
        let c = ComplexNumber::new(2.0, 3.0);
    ...
    fn test_cartesian_to_polar(){
        // this is a really bad example where the cartesian and polar coordinates look the same
        let (ρ, θ) = ComplexNumber::cartesian_to_polar(2.0, 0.0);
        assert_eq!(ρ, 2.0);
        assert_eq!(θ, 0.0);
    }
    ...
    fn test_polar_to_cartesian(){
        // this is a really bad example where the cartesian and polar coordinates look the same
        let (a, b) = ComplexNumber::polar_to_cartesian(2.0, 0.0);
        assert_eq!(a, 2.0);
        assert_eq!(b, 0.0);        
    }
}